...
const AccessibilityPanel: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Accessibility panel */}
      {isOpen && (
        <div className="fixed bottom-20 right-4 rounded-lg shadow-xl p-4 z-40 w-64" style={{background: 'var(--bg-card)', borderColor: 'var(--border-color)', border: '1px solid'}}>
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-3 py-1 rounded disabled:opacity-50 disabled:cursor-not-allowed accessibility-btn"
              ...
              <button
                ...
                className="px-3 py-1 rounded accessibility-btn"
          ...
          <div className="mb-4">
            <label className="flex items-center">
              <input
                ...
                className="mr-2"
              />
              <span className="text-sm text-secondary">High Contrast</span>
            </label>
          </div>
